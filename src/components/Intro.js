...
const IS_ipad = (height === 812 || height === 896) && Platform.OS === '';
...

                        {
                            intro.map((intr, i) => (
                                <View style={[styles.heightFull, { width }]} key={i}>
                                    ...
                                    <View style={{ position: 'absolute', flexDirection: 'column', alignSelf: 'center', alignContent: 'center', flex: 1, justifyContent: 'center', alignItems: 'center', bottom: 160 }}>
